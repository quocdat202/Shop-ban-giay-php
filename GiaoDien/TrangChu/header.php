        ...
        <div class="container">
            ...
            <div class="container page">
                ...
                <div class="social-media order-lg-last">
                    <p class="mb-0 d-flex">
                        <a href="https://www.facebook.com/" target="_blank" class="d-flex align-items-center justify-content-center"><span class="fa fa-facebook-official"><i class="sr-only">Facebook</i></span></a>
